        ...
        <>
            ...
            <div className="pageContainer">
                <div className={styles.detail_section_container}>
                    <h1 className={styles.header}>Motivation</h1>
                ...
                <div className={styles.detail_section_container}>
                    <h1 className={styles.header}>General Algorithm</h1>
                ...
                <div className={styles.detail_section_container}>
                    <h1 className={styles.header}>Prompt</h1>
                ...
                <div className={styles.detail_section_container}>
                    <h1 className={styles.header}>Model</h1>
                    <p className={styles.basic_text}>
                ...
                <div className={styles.detail_section_container}>
                    <h1 className={styles.header}>Manual Clean Ups</h1>
                ...
                <div className={styles.detail_section_container}>
                    <h1 className={styles.header}>Findings</h1>
                    <ul className={styles.unordered_list}>
